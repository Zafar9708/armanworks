...
import React, { useState } from 'react';
import { motion, AnimatePresence } from 'framer-motion';
import { X, Send, Phone, Mail, MapPin, Minus, User, Hash, CheckCircle } from 'lucide-react';
...
const AmranContactSection = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const apiData = {
      ...
      companyName: '', // Not collected in this form
      email: formData.email,
      phone: formData.phone,
      message: formData.message,
      productName: "Technical Inquiry - Amran Contact" // Default value
    };
                  ...
                  <form onSubmit={handleSubmit} className="space-y-7">
                    ...
                    <div className="relative">
                      ...
                      <input 
                        ...
                        required 
                        className="w-full border-b border-gray-200 py-3 focus:border-slate-900 outline-none transition-colors text-sm font-bold text-slate-900 bg-transparent placeholder:text-gray-300" 
                    ...
                    <div className="relative">
                      ...
                      <textarea 
                        ...
                        onChange={handleChange}
                        required 
                        className="w-full border-b border-gray-200 py-3 focus:border-slate-900 outline-none transition-colors text-sm font-bold text-slate-900 bg-transparent resize-none placeholder:text-gray-300" 
                    ...
                    <button 
                      ...
                      className={`w-full mt-4 bg-slate-900 text-white py-5 text-[10px] font-black tracking-[0.4em] uppercase hover:bg-[#D4AF37] hover:text-slate-900 transition-all flex items-center justify-center gap-3 ${
